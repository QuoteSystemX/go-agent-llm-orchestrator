...
2. // turbo
   Run `python3 .agent/scripts/analysis/intent_validator.py "_Context from user message is passed automatically by Claude Code._"`.
3. // turbo
   Run `python3 .agent/scripts/analysis/resource_forecaster.py "_Context from user message is passed automatically by Claude Code._"`.
...
ADDITIONAL FOCUS: _Context from user message is passed automatically by Claude Code._ (e.g. "MVP only", "focus on security stories")
