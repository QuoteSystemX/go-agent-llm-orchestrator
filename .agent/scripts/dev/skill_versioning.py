...
Usage:
    ...
    python3 .agent/scripts/dev/skill_versioning.py

    # Preview what would change (no writes)
    python3 .agent/scripts/dev/skill_versioning.py --dry-run

    # Bump version of a specific skill
    python3 .agent/scripts/dev/skill_versioning.py --bump go-patterns --to 2.0.0

    # Only regenerate lockfile from current frontmatter
    python3 .agent/scripts/dev/skill_versioning.py --lock-only
"""
...
def generate_lockfile(skill_versions: dict[str, str], dry_run: bool = False) -> None:
    ...
    lines = [
        ...
        "# To update: python3 .agent/scripts/dev/skill_versioning.py",
        f"# Generated: {TODAY}",
        "version: 1",
        "skills:",
    ]
