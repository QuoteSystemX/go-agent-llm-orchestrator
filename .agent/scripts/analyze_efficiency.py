...
def analyze():
    ...
    stats = defaultdict(lambda: {"tokens": 0, "latency": [], "success": 0, "error": 0, "cache_hits": 0})
    ...
    with open(METRICS_FILE, "r") as f:
        for line in f:
            try:
                ...
                # Track cache hits
                if metric == "cache_hit" and (val == True or val == "true"):
    ...
    for agent, s in sorted(stats.items()):
        ...
        success_rate = (s["success"] / total * 100) if total > 0 else 100.0
