...
name: go-pkg-go-dev
version: 1.0.0
source: Adapted from samber/cc-skills-golang@golang-pkg-go-dev (MIT License) — https://github.com/samber/cc-skills-golang (pinned 3a82362)
...
files: references/sample-output.md
---
