...
name: go-grpc
version: 1.0.0
source: Adapted from samber/cc-skills-golang@golang-grpc (MIT License) — https://github.com/samber/cc-skills-golang (pinned 3a82362)
...
files: references/protoc-reference.md, references/testing.md
---
