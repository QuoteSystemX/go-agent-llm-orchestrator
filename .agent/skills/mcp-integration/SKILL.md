...
version: 0.1.0
files: examples/http-server.json, examples/sse-server.json, examples/stdio-server.json, references/authentication.md, references/server-types.md, references/tool-usage.md
---
