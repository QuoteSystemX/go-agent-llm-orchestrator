<!--
Source: kepano/obsidian-skills, skills/obsidian-bases/references/FUNCTIONS_REFERENCE.md
https://github.com/kepano/obsidian-skills (MIT License)
Reproduced verbatim — this is the upstream skill this repo's obsidian-bases skill was adapted
from; keep in sync with upstream if it changes, or replace with a link to
https://help.obsidian.md/bases/functions if it drifts out of date.
-->
