...
version: 1.0.0
source: Adapted from samber/cc-skills-golang@golang-dependency-injection (MIT License) — https://github.com/samber/cc-skills-golang (pinned 3a82362)
...
files: references/google-wire.md, references/manual-di.md, references/samber-do.md, references/uber-dig-fx.md
---
