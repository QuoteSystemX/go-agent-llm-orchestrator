...
name: go-gopls
version: 1.0.0
source: Adapted from samber/cc-skills-golang@golang-gopls (MIT License) — https://github.com/samber/cc-skills-golang (pinned 3a82362)
...
files: references/cli.md, references/features.md, references/matrix.md, references/mcp.md, references/settings.md
---
