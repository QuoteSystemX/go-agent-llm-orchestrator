...
1. **Analyst** asks the user:
   - "What is the core mood? (Clean/Corporate, Bold/Experimental, Sleek/Dark)"
   - "Who is the target audience?"
   - "Any reference sites or styles to avoid?"
2. **Visual Designer** analyzes the PRD and mood.

## Phase 2: Design Token Generation
1. **Visual Designer** creates `.agent/design/design-system.json`.
2. Define:
   - **Colors**: HSL Primary, Secondary, Surface, Text.
   - **Typography**: Font family, base size, scale.
   - **Effects**: Shadows, Border Radius, Blurs.

## Phase 3: Visual Mockups
1. **Visual Designer** uses `generate_image` to create:
   - Hero Section mockup.
   - Main Dashboard/Interface mockup.
2. Save artifacts to `docs/design/mockups/`.
