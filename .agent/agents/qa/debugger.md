...
skills: clean-code, systematic-debugging, shared-context, telemetry, behavioral-modes, multica-mcp, multica-cli
...
| Tool | Action | Why? |
| :--- | :--- | :--- |
| `post_mortem_runner.py` | `python3 .agent/scripts/analysis/post_mortem_runner.py` | Get a visual sequence diagram of recent events |
...
| `rollback_task.py` | `python3 .agent/scripts/delivery/rollback_task.py` | If things get messy, rollback and retry systematically |
