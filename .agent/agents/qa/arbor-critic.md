...
hierarchy:
  ...
  delegates_to: []
skills: arbor-agent-merge-eval, code-review-checklist, multica-mcp, multica-cli, llm-regression-testing, clean-code
domains: qa, testing, auditing, merge-gates, benchmarking, regression
